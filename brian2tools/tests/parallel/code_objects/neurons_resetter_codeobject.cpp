...
void _run_neurons_resetter_codeobject()
{
...
const int _num_spikespace = 3;
 ...
 int32_t* __restrict  _ptr_array_neurons__spikespace = _array_neurons__spikespace;



	const int32_t *_events = _ptr_array_neurons__spikespace;
	const int32_t _num_events = _ptr_array_neurons__spikespace[2];

	//// MAIN CODE ////////////	
	// scalar code
	const int _vectorisation_idx = -1;
 	
 const double _lio_1 = (- 70.0) * 0.001;
